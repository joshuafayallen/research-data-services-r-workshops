...
## Select()
- In some cases we just need a few columns 
- We use `select` to grab those columns
...
:::{.notes}
Select is a lot more intuitive because with some exceptions you just supply a set of column names you want or do want. Select has a whole set of really awesome helper function that help you subset your data easier. I have included those at the end. Just so you are aware of them.
