...
:::{.notes}
The entire tidyverse paradigm is sort of centered around this idea and how to make manipulating data a lot less painful. We will cover this towards the end but heuristically the idea of the tidyverse is centered around this paradimgm
...
-   That is why it is generally best practice to load the `tidyverse` last
