...
+------------------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------+
| Extract rows with `filter()`       | ![filter](https://raw.githubusercontent.com/andrewheiss/2021-seacen/main/01_welcome-tidyverse/slides/img/01/filter.png "filter"){alt="filter"}             |
+------------------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------+
| Extract columns with `select()`    | ![select](https://raw.githubusercontent.com/andrewheiss/2021-seacen/main/01_welcome-tidyverse/slides/img/01/select.png "select"){alt="select"}             |
+------------------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------+
| Arrange/sort rows with `arrange()` | ![arrange](https://raw.githubusercontent.com/andrewheiss/2021-seacen/main/01_welcome-tidyverse/slides/img/01/arrange.png "arrange"){alt="arrange"}         |
+------------------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------+
| Make new columns with `mutate()`   | ![mutate](https://raw.githubusercontent.com/andrewheiss/2021-seacen/main/01_welcome-tidyverse/slides/img/01/mutate.png "mutate"){alt="mutate"}             |
+------------------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------+
| Make group summaries with\         | ![summarize](https://raw.githubusercontent.com/andrewheiss/2021-seacen/main/01_welcome-tidyverse/slides/img/01/summarize.png "summarize"){alt="summarize"} |
| `group_by() %>% summarize()`       |                                                                                                                                                            |
+------------------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------+
...
::: callout
Example provided by [Grant McDermot](https://github.com/uo-ec607/lectures)
:::
...
::: aside
You may see me use `summarise` this is the same thing as `summarize`.
:::
