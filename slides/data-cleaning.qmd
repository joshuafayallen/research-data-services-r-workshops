...
# Various Other Helpful Tidyverse Things 
...
- Unite: combine mulitple columns into one column
- Seperate: Split one column into many 

```{r}

 f1_data = read_csv("data/f1_data.csv") |>
