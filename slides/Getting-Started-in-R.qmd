...
pacman::p_load("ggplot2", "AllenMisc", "magrittr","dplyr", "flair", "MetBrewer", "colorspace",  install = FALSE)
...
different classes of objects have different attributes that make them that class of object. A data.frame is kind of list where element in it has an equal length. Whereas a list can consist of elements of different lenghts. 
