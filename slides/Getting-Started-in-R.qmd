...
pacman::p_load("ggplot2", "AllenMisc", "magrittr","dplyr", "flair", "MetBrewer", "colorspace",  "palmerpenguins", install = FALSE)
...
# Research Data Services {background-color="`r clrs[5]`" .white }


## 

<center>
<iframe src="https://giphy.com/embed/xTiIzJSKB4l7xTouE8" width="800" height="400" frameBorder="0" class="giphy-embed" allowFullScreen></iframe><p><a href="https://giphy.com/gifs/starwars-star-wars-episode-3-xTiIzJSKB4l7xTouE8">via GIPHY</a></p>
...
# The Workshop {background-color="`r clrs[3]`" .white}
...
- Tbh this is a matter of taste really. 
  - R added `=` in the 2000's to make it easier for people coming from other object oriented programming languages^[More discussion [here](https://github.com/Robinlovelace/geocompr/issues/319##issuecomment-427376764) and [here](https://www.separatinghyperplanes.com/2018/02/why-you-should-use-and-never.html)]

- Just keep it consistent..[or become ungovernable and use all three in one script.]{.fragment}
...
- <font style="color: #591d06">**Atomic**</font>: all the stuff must be the same type

- <font style="color: #591d06">**Lists**</font>: stuff can be different types
```{r echo = TRUE}
my_vec <- c(1:10)
is.vector(my_vec)
```
