...
euros_feols = feols(Euros ~ log(dist_km) | Origin + Destination + Product + Year, data = trade),

euro_stand = lm(Euros ~ log(dist_km) + factor(Origin) + factor(Destination) + factor(Product) + factor(Year), data = trade),


euros_plm = plm(Euros ~ log(dist_km) +  Origin + Destination + Product + Year
                 , data = trade, model = "within")
```
