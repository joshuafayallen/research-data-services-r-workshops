...
t.test(penguins_t_test$flipper_length_mm, penguins_t_test$bill_length_mm, var.equal = TRUE) # this is just to show you some of the options
```
...
t.test(penguins_t_test$flipper_length_mm, penguins_t_test$bill_length_mm, var.equal = TRUE)  # 
```
