...
clrs <- MetBrewer::met.brewer(name = "Demuth")
...
#| fig-alt: "This plot shows the importance of visualizing data. Each dataset visualized have relatively the same mean and standard deviations. However they have very different visual patterns. The first figure is a circle, the second figure is a dinosaur, the second figure is 6 lines decreasing on the Y axis, the next figure is 6 lines increasing on the y axis, the next figure creates a star, and the last figure creates an X. These figures were all made from data that appear to have the same mean and standard deviation both measures just vary at the margins"
...
ggplot(penguins, aes(x = bill_length_mm, y = body_mass_g, shape = species, color = island)) + theme_void() + geom_point(size = 3) + labs(x = "Bill Length(mm)", y = "Body Mass(g)")
```
...
ggplot() +
         geom_point(data = penguins,mapping =  aes(
         x = bill_length_mm, 
         y = body_mass_g,
         shape = species, 
         color = island, 
...
:::columns
:::column
```{r complex-plot-no-geoms-show, eval=FALSE, echo = TRUE}
ggplot(gapminder, aes(x = gdpPercap,
 y = lifeExp))
```
...
:::column
```{r complex-plot-no-geoms-out, echo=FALSE}
...
:::columns
:::column
```{r complex-plot-add-geom-point-show, eval=FALSE, echo = TRUE}
...
:::column
```{r complex-plot-add-geom-point-out, echo=FALSE}
ggplot(gapminder, aes(x = gdpPercap,
                      y = lifeExp,
                      color = continent)) +
  geom_point()
...
::: columns
:::column
```{r complex-plot-add-geom-smooth-show, eval=FALSE, echo = TRUE}
ggplot(gapminder, aes(x = gdpPercap,
                      y = lifeExp,
                      color = continent)) +
  geom_point() +
...
:::column
```{r complex-plot-add-geom-smooth-out, echo=FALSE}
ggplot(gapminder, aes(x = gdpPercap,
                      y = lifeExp,
                      color = continent)) +
  geom_point() +
...
::: columns 
:::column
```{r complex-plot-add-log-show, eval=FALSE, echo = TRUE}
ggplot(gapminder, aes(x = gdpPercap,
                      y = lifeExp,
                      color = continent)) +
  geom_point() +
...
:::column
```{r complex-plot-add-log-out, echo=FALSE}
ggplot(gapminder, aes(x = gdpPercap,
                      y = lifeExp,
                      color = continent)) +
  geom_point() +
...
::: columns
:::column
```{r complex-plot-add-labs-out, eval=FALSE, echo = TRUE}
ggplot(gapminder, aes(x = gdpPercap,
                      y = lifeExp,
                      color = continent)) +
  geom_point() +
...
:::column
```{r complex-plot-add-labs-show, echo=FALSE}
ggplot(gapminder, aes(x = gdpPercap,
                      y = lifeExp,
                      color = continent)) +
  geom_point() +
...
:::columns
:::column
```{r complex-plot-add-viridis-show, eval=FALSE, echo = TRUE}
ggplot(gapminder, aes(x = gdpPercap,
                      y = lifeExp,
                      color = continent)) +
  geom_point() +
...
:::column
```{r complex-plot-viridis-out, echo=FALSE}
ggplot(gapminder, aes(x = gdpPercap,
                      y = lifeExp,
                      color = continent)) +
  geom_point() +
...
```{r complex-plot-add-theme-show, eval=FALSE, echo = TRUE}
ggplot(gapminder, aes(x = gdpPercap,
                      y = lifeExp,
                      color = continent)) +
  geom_point() +
...
:::column
```{r complex-plot-add-theme-out, echo=FALSE}
ggplot(gapminder, aes(x = gdpPercap,
                      y = lifeExp,
                      color = continent)) +
  geom_point() +
...
```{r complex-plot-facet-show, eval=FALSE, echo = TRUE}
ggplot(gapminder, aes(x = gdpPercap,
                      y = lifeExp,
                      color = continent)) +
  geom_point() +
...
::: {.column width="55%"}
```{r complex-plot-facet-out, echo=FALSE}
ggplot(gapminder, aes(x = gdpPercap, y = lifeExp, color = continent)) +
  geom_point() +
  geom_smooth() +
  scale_x_log10() +
...
::::{.columns}
::: {.column width="45%"}
```{r change-default-theme-option-complex-plot-show, eval=FALSE, echo = TRUE}
ggplot(gapminder, aes(x = gdpPercap,
                      y = lifeExp,
                      color = continent)) +
  geom_point() +
...
::: {.column width="55%"}
```{r change-default-theme-option-complex-plot-out, echo=FALSE}
ggplot(gapminder, aes(x = gdpPercap, y = lifeExp, color = continent)) +
  geom_point() +
  geom_smooth() +
  scale_x_log10() +
...
ggplot(gapminder, aes(x = gdpPercap,
  ...
  theme_allen_bw() +
  guides(size = guide_legend(reverse = TRUE, title = "Population"), color =   guide_legend(title = "Continent"))
```
...
```{r show-options-for-scales, eval = FALSE, echo = TRUE}
...
```{r make-plots-for-options-scales}
#| layout-ncol: 2
...
```{r scale-x-continous-example, echo=TRUE, eval = FALSE}
...
```{r fill-bill-length-options-timer}
...
```{r changing-viridis-options-show, eval = FALSE, echo = TRUE}
...
```{r changing-viridis-options-out, echo = FALSE}
...
```{r facet-wrap-one-col, echo=TRUE, eval = FALSE}
#| code-line-numbers: "|5|7|14"
ggplot(gapminder, aes(x = gdpPercap, y = lifeExp, size = pop)) +
  geom_point() +
  theme_bw() +
  scale_x_log10() +
  facet_wrap(vars(continent)) # you can add more combos of vars here
  
ggplot(data = filter(gapminder, year %in% c(1987,1997,2002, 2007)),
       aes(x = gdpPercap,
           y = lifeExp,
           size = pop)) +
  geom_point() +
...
```{r labels-example-show, eval = FALSE, echo = TRUE}
ggplot(gapminder, 
       aes(x = gdpPercap,
        y = lifeExp, 
           color = continent,
...
```{r labels-example-out, echo = FALSE}
ggplot(gapminder, 
       aes(x = gdpPercap,
        y = lifeExp, 
           color = continent,
...
```{r cleaning-dem-data, echo= FALSE}
